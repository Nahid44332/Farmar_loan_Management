...
@section('content')
    ...
    <div class="page_area">
        ...
        <div class="main_wrapper">
            ...
            <form action="{{ url('admin/cow/update/', $cowService->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $cowService->name }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="desc_one" class="form-control" placeholder="Write first description">{{ $cowService->desc_one }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="desc_two" class="form-control" placeholder="Write second description">{{ $cowService->desc_two }}</textarea>
                        ...
                        <div class="col-lg-5 mt-4 mt-lg-0">
                            ...
                            <div class="image_upload_box">
                                ...
                                <img src="{{ asset($cowService->image) }}" class="preview_img">
            ...
            <div class="section_card">
                ...
                <form action="{{ url('/admin/cow/benefit/save/' . $cowService->id) }}" method="POST">
                    @csrf
            ...
            <div class="section_card">
                ...
                <form action="{{ route('rice.faq.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="service_id" value="{{ $cowService->id }}">
