...
@section('content')
    <style>
        ...
        /* =========================STATIC SIDEBAR========================= */
        /* == এই সাইটবারে রেসপন্সিভ সমস্যা রয়েছে == */
        .sidebar {
            position: fixed;
            top: 0;
            left: 0;
    ...
    <div class="page_area">
        ...
        <div class="main_wrapper">
            ...
            <form action="{{ route('rice.update', $riceService->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" class="form-control" value="{{ $riceService->name }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="desc_one" class="form-control" placeholder="Write first description">{{ $riceService->desc_one }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea name="desc_two" class="form-control" placeholder="Write second description">{{ $riceService->desc_two }}</textarea>
                        ...
                        <div class="col-lg-5 mt-4 mt-lg-0">
                            ...
                            <div class="image_upload_box">
                                ...
                                <img src="{{ asset($riceService->image) }}" class="preview_img">
            ...
            <div class="section_card">
                ...
                <form action="{{ url('/admin/rich/benefit/save/' . $riceService->id) }}" method="POST">
                    @csrf
            ...
            <div class="section_card">
                ...
                <form action="{{ route('rice.faq.store') }}" method="POST">
                    @csrf
                    <input type="hidden" name="service_id" value="{{ $riceService->id }}">
