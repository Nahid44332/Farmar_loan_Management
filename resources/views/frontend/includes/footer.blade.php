 <!-- footer section start -->
         ...
         <div class="footer_section_2">
            <div class="row">
               ...
               <div class="col-lg-3 col-sm-6">
                  ...
                  <div class="footer_menu">
                     <ul>
                        ...
                        <li><a href="terms _conditions.html">Terms & Conditions</a></li>
               ...
               <div class="col-lg-3 col-sm-6">
                  ...
                  <p class="lorem_text">Readable content of a page when looking at its layoutreadable content of a page
   ...
   <div class="copyright_section">
      <div class="container">
         <div class="row">
            <div class="col-sm-12">
               <p class="copyright_text">2026 All Rights Reserved. Design by <a href="#">Nusrat Jahan</a></p>
            </div>
         </div>
      </div>
   </div>
